...
<head>
    ...
    <title>Trip 3 Hari - GoJatim</title>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('{{ asset('images/destinations/bukit teletubbies.jpg') }}') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                <a href="{{ url('/destinations') }}" class="dropdown-trigger nav-active">Destinasi <span class="arrow">▾</span></a>
                    ...
                    <li><a href="{{ url('/trip/3') }}"  class="trip-active">Trip 3 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="{{ url('/destinations') }}">Destinasi</a> &nbsp;/&nbsp; Trip 3 Hari
            </p>
            <h1>Trip <strong>3 Hari</strong></h1>
            <div class="hero-meta">
    ...
    <div class="trip-section">
        <div class="trip-intro reveal">
            <div>
                ...
                <h2 class="trip-desc-title">Tiga hari eksplorasi,<br><em>alam tak terbatas</em></h2>
                <p class="trip-desc-body">
                    Paket 3 hari adalah sweet spot antara kedalaman pengalaman dan efisiensi waktu. Tiga destinasi yang saling melengkapi — air terjun, sabana hijau, dan pantai selatan dramatis.
                </p>
                <p class="trip-desc-body" style="margin-top: 14px;">
                    Cocok untuk long weekend. Dua malam menginap di penginapan lokal yang nyaman dengan sarapan tradisional setiap pagi.
                </p>
            </div>
            <div class="trip-info-box reveal">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value">3 Hari 2 Malam</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Destinasi</span>
                    <span class="value">3 Tempat</span>
                </div>
                <div class="trip-info-row">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value">±17.00 WIB (H+2)</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Kapasitas</span>
                    <span class="value">Maks. 10 orang</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Tingkat</span>
                    <span class="value">Mudah – Sedang</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Harga mulai</span>
                    <span class="value" style="color: var(--accent-terra)">Rp 1.200.000</span>
                </div>
                <a href="/booking/3" class="btn-book">Pesan Sekarang →</a>
            </div>
        </div>
        ...
        <div class="reveal">
            ...
            <h2 class="section-title-md">3 Tempat <em>terpilih</em></h2>
        </div>
            ...
            <div class="dest-card-item reveal">
                ...
                <div class="dest-card-body">
                    ...
                    <p class="dest-card-desc">Air terjun bertingkat yang tersembunyi di lereng Gunung Arjuno. Trek 2 jam melewati hutan tropis yang masih sangat alami.</p>
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="{{ asset('images/destinations/bukit teletubbies.jpg') }}" alt="Bukit Teletubbies" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Hidden Gem</span>
                </div>
                <div class="dest-card-body">
                    <p class="dest-card-region"><i class="fas fa-map-marker-alt" style="margin-right:4px"></i>Kab. Probolinggo · Jawa Timur</p>
                    <h3 class="dest-card-name">Bukit Teletubbies</h3>
                    <p class="dest-card-desc">Padang sabana hijau berbukit-bukit di kaki Bromo yang jarang masuk itinerary wisatawan.</p>
                    <div class="dest-card-footer">
                        <span><i class="fas fa-map" style="margin-right:4px"></i>Sabana</span>
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="{{ asset('images/destinations/Pantai Ngliyep.jpg') }}" alt="Pantai Ngliyep" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Pantai</span>
                </div>
                <div class="dest-card-body">
                    <p class="dest-card-region"><i class="fas fa-map-marker-alt" style="margin-right:4px"></i>Kab. Malang · Jawa Timur</p>
                    <h3 class="dest-card-name">Pantai Ngliyep</h3>
                    <p class="dest-card-desc">Pantai selatan yang dramatis dengan tebing karang dan ombak ganas. Bukan untuk berenang, tapi untuk menikmati keagungan alam.</p>
                    <div class="dest-card-footer">
                        <span><i class="fas fa-map" style="margin-right:4px"></i>Pantai</span>
                        <span class="rating"><i class="fas fa-star" style="margin-right:4px"></i>4.5</span>
                    </div>
                </div>
            </div>
        </div></div>
        ...
        <div class="itinerary-inner">
            ...
            <h2 class="section-title-md reveal">Itinerary <em>Harian</em></h2>
                ...
                <div class="timeline-item reveal">
                    ...
                    <h4 class="timeline-title">Hari 1 — Coban Baung</h4>
                    <p class="timeline-desc">Berangkat dari Surabaya menuju Pasuruan. Trek 2 jam ke air terjun tersembunyi di lereng Arjuno.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">14.00 WIB</p>
                    <h4 class="timeline-title">Menuju Probolinggo</h4>
                    <p class="timeline-desc">Check-in penginapan di sekitar Probolinggo. Istirahat sore, makan malam bersama.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">06.00 WIB</p>
                    <h4 class="timeline-title">Hari 2 — Bukit Teletubbies</h4>
                    <p class="timeline-desc">Pagi cerah di sabana hijau kaki Bromo. Foto-foto, jalan santai di antara bukit bergelombang.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">13.00 WIB</p>
                    <h4 class="timeline-title">Perjalanan ke Malang Selatan</h4>
                    <p class="timeline-desc">Menuju penginapan dekat Pantai Ngliyep. Singgah makan siang di Malang kota.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">06.00 WIB</p>
                    <h4 class="timeline-title">Hari 3 — Pantai Ngliyep</h4>
                    <p class="timeline-desc">Pagi di tepi tebing karang. Sunrise dramatis di atas Samudra Hindia, sarapan dengan pemandangan laut.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">11.00 WIB</p>
                    <h4 class="timeline-title">Perjalanan Pulang</h4>
                    <p class="timeline-desc">Santai menyusuri jalan pesisir selatan Malang sebelum kembali ke Surabaya.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">±17.00 WIB</p>
                    <h4 class="timeline-title">Tiba di Surabaya</h4>
                    <p class="timeline-desc">Perjalanan 3 hari berakhir dengan 3 kenangan yang tak terlupakan.</p>
                </div>
            </div>            </div>
        </div>
    </section>
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            <p class="other-trips-label">Paket Lainnya</p>
                ...
                <a href="{{ url('/trip/3') }}" class="other-trip-btn current">Trip 3 Hari</a>

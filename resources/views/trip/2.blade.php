...
<head>
    ...
    <title>Trip 2 Hari - GoJatim</title>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('{{ asset('images/destinations/Gunung Raung.jpg') }}') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                <a href="#" class="dropdown-trigger nav-active">Destinasi <span class="arrow">▾</span></a>
                                <ul class="dropdown-menu">
                    <li><a href="{{ url('/trip/1') }}" >Trip 1 Hari</a></li>
                    <li><a href="{{ url('/trip/2') }}"  class="trip-active">Trip 2 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="{{ url('/destinations') }}">Destinasi</a> &nbsp;/&nbsp; Trip 2 Hari
            </p>
            <h1>Trip <strong>2 Hari</strong></h1>
            <div class="hero-meta">
    ...
    <div class="trip-section">
        <div class="trip-intro reveal">
            <div>
                ...
                <h2 class="trip-desc-title">Petualangan dua hari,<br><em>dua puncak terbaik</em></h2>
                <p class="trip-desc-body">
                    Paket 2 hari dirancang untuk kamu yang ingin menjelajah lebih dalam tanpa terburu-buru. Dua destinasi premium yang dipilih secara kurasi — gunung berapi aktif dan danau pegunungan yang tersembunyi.
                </p>
                <p class="trip-desc-body" style="margin-top: 14px;">
                    Menginap satu malam di penginapan lokal pilihan, merasakan kehangatan hospitality warga setempat di kaki gunung.
                </p>
            </div>
            <div class="trip-info-box reveal">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value">2 Hari 1 Malam</span>
                </div>
                <div class="trip-info-row">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value">±18.00 WIB (H+1)</span>
                </div>
                <div class="trip-info-row">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value" style="color: var(--accent-terra)">Rp 850.000</span>
                </div>
                <a href="/booking/2" class="btn-book">Pesan Sekarang →</a>
            </div>
        </div>
        ...
        <div class="reveal">
            ...
            <div class="dest-card-item reveal">
                ...
                <div class="dest-card-body">
                    ...
                    <p class="dest-card-desc">Kaldera aktif terluas di Jawa dengan medan ekstrem. Hanya untuk pendaki berpengalaman — pemandangannya tak tertandingi.</p>
            ...
            <div class="dest-card-item reveal">
                ...
                <div class="dest-card-body">
                    ...
                    <p class="dest-card-desc">Danau alami di ketinggian 734 mdpl dikelilingi hutan pinus. Kabut pagi yang dramatis dan suasana tenang.</p>
                    <div class="dest-card-footer">
        ...
        <div class="itinerary-inner">
            ...
            <h2 class="section-title-md reveal">Itinerary <em>Harian</em></h2>
                ...
                <div class="timeline-item reveal">
                    ...
                    <h4 class="timeline-title">Hari 1 — Berangkat ke Banyuwangi</h4>
                    <p class="timeline-desc">Berangkat dari Surabaya menuju basecamp Gunung Raung. Perjalanan ±6 jam dengan pemberhentian di warung lokal.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">12.00 WIB</p>
                    <h4 class="timeline-title">Tiba di Basecamp Raung</h4>
                    <p class="timeline-desc">Check-in, istirahat, briefing pendakian. Makan siang bersama sebelum mulai trekking sore.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">14.00 WIB</p>
                    <h4 class="timeline-title">Trekking Menuju Pos 1</h4>
                    <p class="timeline-desc">Mulai pendakian ke pos 1. Medan hutan tropis yang lebat dengan panduan pemandu berpengalaman.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">17.00 WIB</p>
                    <h4 class="timeline-title">Camp di Pos 1</h4>
                    <p class="timeline-desc">Mendirikan tenda, memasak, dan menikmati langit malam di ketinggian yang jauh dari polusi cahaya.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">05.00 WIB</p>
                    <h4 class="timeline-title">Hari 2 — Puncak & Turun</h4>
                    <p class="timeline-desc">Dini hari menuju puncak untuk menyaksikan matahari terbit dari atas kaldera. Turun sekitar pukul 09.00.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">12.00 WIB</p>
                    <h4 class="timeline-title">Telaga Ngebel, Ponorogo</h4>
                    <p class="timeline-desc">Singgah di danau pegunungan yang tenang. Makan siang di tepi danau, bersantai sebelum pulang.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">±18.00 WIB</p>
                    <h4 class="timeline-title">Tiba di Surabaya</h4>
                    <p class="timeline-desc">Perjalanan 2 hari selesai dengan kenangan yang membekas.</p>
                </div>
            </div>            </div>
        </div>
    </section>
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            <p class="other-trips-label">Paket Lainnya</p>
                ...
                <a href="{{ url('/trip/2') }}" class="other-trip-btn current">Trip 2 Hari</a>

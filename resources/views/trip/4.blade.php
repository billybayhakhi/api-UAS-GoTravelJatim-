...
<head>
    ...
    <title>Trip 4 Hari - GoJatim</title>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('{{ asset('images/destinations/bukit mongkrang.jpg') }}') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                <a href="{{ url('/destinations') }}" class="dropdown-trigger nav-active">Destinasi <span class="arrow">▾</span></a>
                    ...
                    <li><a href="{{ url('/trip/4') }}"  class="trip-active">Trip 4 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="{{ url('/destinations') }}">Destinasi</a> &nbsp;/&nbsp; Trip 4 Hari
            </p>
            <h1>Trip <strong>4 Hari</strong></h1>
            <div class="hero-meta">
    ...
    <div class="trip-section">
        <div class="trip-intro reveal">
            <div>
                ...
                <h2 class="trip-desc-title">Empat hari,<br><em>empat wajah Jawa Timur</em></h2>
                <p class="trip-desc-body">
                    Paket 4 hari adalah perjalanan paling komprehensif untuk merasakan keragaman Jawa Timur — dari situs sejarah Majapahit, puncak Gunung Lawu, pantai terpencil, hingga kaldera aktif.
                </p>
                <p class="trip-desc-body" style="margin-top: 14px;">
                    Tiga malam menginap, makan bersama setiap hari, dan pemandu lokal yang berbeda di setiap destinasi untuk pengalaman paling autentik.
                </p>
            </div>
            <div class="trip-info-box reveal">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value">4 Hari 3 Malam</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Destinasi</span>
                    <span class="value">4 Tempat</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Keberangkatan</span>
                    <span class="value">06.00 WIB</span>
                </div>
                <div class="trip-info-row">
                    <span class="label">Kembali</span>
                    <span class="value">±18.00 WIB (H+3)</span>
                </div>
                <div class="trip-info-row">
                ...
                <div class="trip-info-row">
                    ...
                    <span class="value" style="color: var(--accent-terra)">Rp 1.850.000</span>
                </div>
                <a href="/booking/4" class="btn-book">Pesan Sekarang →</a>
            </div>
        </div>
        ...
        <div class="reveal">
            ...
            <h2 class="section-title-md">4 Tempat <em>terpilih</em></h2>
        </div>
            ...
            <div class="dest-card-item reveal">
                ...
                <div class="dest-card-body">
                    ...
                    <p class="dest-card-desc">Reruntuhan ibukota kerajaan terbesar Nusantara. Candi, kolam, dan museum yang menyimpan kejayaan abad ke-13.</p>
            ...
            <div class="dest-card-item reveal">
                ...
                <div class="dest-card-body">
                    ...
                    <p class="dest-card-desc">Padang edelweis di lereng Gunung Lawu dengan pemandangan matahari terbit paling indah di Jawa Timur bagian barat.</p>
                    <div class="dest-card-footer">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="{{ asset('images/destinations/Watu karung beach.jpg') }}" alt="Pantai Watu Karung" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Hidden Gem</span>
                </div>
                <div class="dest-card-body">
                    <p class="dest-card-region"><i class="fas fa-map-marker-alt" style="margin-right:4px"></i>Kab. Pacitan · Jawa Timur</p>
                    <h3 class="dest-card-name">Pantai Watu Karung</h3>
                    <p class="dest-card-desc">Pantai terpencil dengan ombak kelas dunia, surga para peselancar yang belum ramai turis.</p>
                    <div class="dest-card-footer">
                        <span><i class="fas fa-map" style="margin-right:4px"></i>Pantai</span>
                        <span class="rating"><i class="fas fa-star" style="margin-right:4px"></i>4.8</span>
                    </div>
                </div>
            </div>
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="{{ asset('images/destinations/Gunung Raung.jpg') }}" alt="Gunung Raung" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Trekking</span>
                </div>
                <div class="dest-card-body">
                    <p class="dest-card-region"><i class="fas fa-map-marker-alt" style="margin-right:4px"></i>Kab. Banyuwangi · Jawa Timur</p>
                    <h3 class="dest-card-name">Gunung Raung</h3>
                    <p class="dest-card-desc">Kaldera aktif terluas di Jawa. Pendakian ekstrem dengan reward panorama yang tak tertandingi.</p>
                    <div class="dest-card-footer">
                        <span><i class="fas fa-map" style="margin-right:4px"></i>Gunung</span>
                        <span class="rating"><i class="fas fa-star" style="margin-right:4px"></i>4.9</span>
                    </div>
                </div>
            </div>
        </div></div>
        ...
        <div class="itinerary-inner">
            ...
            <h2 class="section-title-md reveal">Itinerary <em>Harian</em></h2>
                ...
                <div class="timeline-item reveal">
                    ...
                    <p class="timeline-time">06.00 WIB</p>
                    <h4 class="timeline-title">Hari 1 — Situs Majapahit, Mojokerto</h4>
                    <p class="timeline-desc">Mulai perjalanan dari Surabaya ke Trowulan. Tur museum, candi, dan kolam Majapahit bersama pemandu sejarah.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">14.00 WIB</p>
                    <h4 class="timeline-title">Menuju Karanganyar</h4>
                    <p class="timeline-desc">Perjalanan panjang ke barat. Makan malam di Solo, menginap di penginapan kaki Gunung Lawu.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">04.00 WIB</p>
                    <h4 class="timeline-title">Hari 2 — Summit Bukit Mongkrang</h4>
                    <p class="timeline-desc">Trek dini hari untuk sunrise. Padang edelweis dan panorama Gunung Merapi-Merbabu dari puncak Lawu.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">12.00 WIB</p>
                    <h4 class="timeline-title">Menuju Pacitan</h4>
                    <p class="timeline-desc">Turun gunung, makan siang, lanjut perjalanan ke pesisir selatan Pacitan.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">07.00 WIB</p>
                    <h4 class="timeline-title">Hari 3 — Pantai Watu Karung</h4>
                    <p class="timeline-desc">Seharian di pantai tersembunyi. Surfing opsional, snorkeling, atau sekadar relaksasi tepi batu karang.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">05.00 WIB</p>
                    <h4 class="timeline-title">Hari 4 — Menuju Raung, Banyuwangi</h4>
                    <p class="timeline-desc">Perjalanan ke basecamp Raung. Trekking singkat ke pos 2 untuk melihat kaldera aktif dari jarak aman.</p>
                </div>
                <div class="timeline-item reveal">
                    <div class="timeline-dot"></div>
                    <p class="timeline-time">±18.00 WIB</p>
                    <h4 class="timeline-title">Tiba di Surabaya</h4>
                    <p class="timeline-desc">Empat hari, empat destinasi, satu Jawa Timur yang luar biasa.</p>
                </div>
            </div>            </div>
        </div>
    </section>
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            <p class="other-trips-label">Paket Lainnya</p>
                ...
                <a href="{{ url('/trip/4') }}" class="other-trip-btn current">Trip 4 Hari</a>
                <a href="{{ url('/trip/5') }}" class="other-trip-btn">Trip 5 Hari</a>
            </div>            </div>
        </div>
    </section>
